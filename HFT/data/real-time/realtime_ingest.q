...
//connect to ticker plant (not needed for our setup)
/ h:neg hopen `:localhost:5002 /
...
/ Processing is handled by process.q on port 5011
/ These functions are commented out as they're not needed in the ingest process
